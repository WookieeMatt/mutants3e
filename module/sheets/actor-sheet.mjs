 ...
 * @extends {ActorSheet}
 */
export class Mutants3EActorSheet extends ActorSheet {

  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["mutants3e", "sheet", "actor"],
      template: "systems/mutants3e/templates/actor/actor-sheet.hbs",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/mutants3e/templates/actor/actor-${this.actor.data.type}-sheet.hbs`;
  }
